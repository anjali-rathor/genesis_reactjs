...
// complete
    ...
    const interestedlocation = ['Delhi/NCR', 'Out of NCR','Other', 'Delhi/NCR','Out of NCR'];
    ...
    const negotiableperiod = ['Yes', 'No, not resigned', 'No', 'Yes', 'No, not resigned'];
    const okaytoremotejob = ['Okay with remote/in-office jobs', 'No', 'Okay with remote/in-office jobs', 'No', 'Okay with remote/in-office jobs'];
    const citiesNcr = ['Delhi', 'Noida','haryana', 'faridabad','gurgao'];
    const desirecitiesworking = ['haryana', 'hisar','Delhi', 'Noida','punjab'];

    const full_time_job_experience = ['0 years', '1 years','2 years', '3 years','4 years'];
    const report_people = ['Not managing a team', 'Less than 10 people','More than 10 people', 'Not managing a team','Less than 10 people'];
    const top_skill = ['{"html":"Beginner","css":"Intermediate","react":"Advanced"}', '{"react":"Intermediate"}','{"SQl":"Advanced"}', '{"html":"Expert","css":"Expert"}','{"sql":"Expert"}'];

    const describeJobIda = ['{"Seed (1-10)":"Ideal","Early (11-50)":"Yes","Mid-Size (51-200)":"No","Large (201-500)":"No","Very-Large (501-1000)":"Yes","Massive (1000+)":"Ideal"}', '{"Seed (1-10)":"Ideal","Early (11-50)":"Ideal","Mid-Size (51-200)":"Yes","Large (201-500)":"Yes","Very-Large (501-1000)":"No","Massive (1000+)":"No"}', '{"Seed (1-10)":"Ideal","Early (11-50)":"Yes","Mid-Size (51-200)":"No","Large (201-500)":"No","Very-Large (501-1000)":"Yes","Massive (1000+)":"Ideal"}', '{"Seed (1-10)":"Ideal","Early (11-50)":"Ideal","Mid-Size (51-200)":"Yes","Large (201-500)":"Yes","Very-Large (501-1000)":"No","Massive (1000+)":"No"}', '{"Seed (1-10)":"Ideal","Early (11-50)":"Yes","Mid-Size (51-200)":"No","Large (201-500)":"No","Very-Large (501-1000)":"Yes","Massive (1000+)":"Ideal"}'];
    
    const hear_aboutUs =['Word of Mouth','Job Portal','Advertisement','Job Portal','Advertisement'];
    const job_search =['Open to new opportunities','variety of opportunities','Open to new opportunities','variety of opportunities','Open to new opportunities'];
    ...
    const pickRandomName = () => {
        const randomIndex = Math.floor(Math.random() * names.length,lastNames.length,userNames.length,emails.length,countryNames.length,passwords.length,interestedrole.length,interestedlocation.length,title.length,currentsalaryCtc.length,fixedsalaryCtc.length,expectedsalaryCtc.length,muchExpectedsalaryCtc.length,startedperiod.length,longperiod.length,negotiableperiod.length,okaytoremotejob.length,citiesNcr.length,desirecitiesworking.length,full_time_job_experience.length,report_people.length,top_skill.length,describeJobIda.length,hear_aboutUs.length,job_search.length,github.length);
        ...
        e.preventDefault();
          ...
          axios.post(baseURL, user_data1).then((res) => {
            ...
            // Second API call with data from the first API response
                axios.post(verifyEmail_URL, user_data2)
                      ...
                      if (isChecked === true) {
                        ...
                        .then((personUIDD) => {
                          ...
                          const user_data3 = {
                            ...
                            desireCitiesWorking:data.desireCitiesWorking || randomDesireCitiesWorking,
                          ...
                          axios.post(userintroURL, user_data3, config)
                          .then((res) => res.json())
                          .then((data) => {
                            console.log(data);
                          ...
                          const experience_data = {
                            full_time_job_experience: data.full_time_job_experience || randomFullTimeJobExperience,
...
<div className="container">
  <form onSubmit={formSubmit}>
    <div className="row jumbotron box8" >
      ...
      {isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="currentLocation">Where are you currently located?</label>
        <input
          type="text"
          className="form-control"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="expectedCtc">What is your Minimum Expected Total CTC?</label>
        <input
          type="text"
          className="form-control"
          name="expectedCtc"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="muchExpectedCtc">Of The total expected CTC , how much do you expect as a fixed?</label>
        <input
          type="text"
          className="form-control"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="startedPeriod">Have you started serving your notice period?</label>
        <input
          type="text"
          className="form-control"
          name="startedPeriod"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="longPeriod"> How long is your notice period?</label>
        <input
          type="text"
          className="form-control"
          name="longPeriod"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="negotiablePeriod"> Is your notice period negotiable</label>
        <input
          type="text"
          className="form-control"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="okaytoRemoteJob">Are You okay with remote job?</label>
        <input
          type="text"
          className="form-control"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="desireCitiesWorking">Desired city to work in?</label>
        <input
          type="text"
          className="form-control"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="full_time_job_experience">How many years do you have a full time experience?</label>
        <input
          type="text"
          className="form-control"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="report_people">How many people report to you ? (Directly or Indirectly)</label>
        <input
          type="text"
          className="form-control"
          name="report_people"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="top_skill">Pick your top frameworks, skills and technologies.(up to 8)</label>
        <input
          type="text"
          className="form-control"
          name="top_skill"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="achievement">What is your biggest Achievement</label>
        <input
          type="text"
          className="form-control"
          name="achievement"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="describeJobIda">Would you work at companies of these size?</label>
        <input
          type="text"
          className="form-control"
          name="describeJobIda"
...
{isChecked && (
      ...
      {isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="hear_aboutUs">How did you hear about us ?</label>
        <input
          type="text"
          className="form-control"
          name="hear_aboutUs"
      ...
      {isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="job_search">Where are you in your job search ?</label>
        <input
          type="text"
          className="form-control"
          name="job_search"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="ready_to_interview">When will you be ready to start interviewing with company?</label>
        <input
          type="text"
          className="form-control"
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="hidden_form">Why do you want to work in our company?</label>
        <input
          type="text"
          className="form-control"
          name="hidden_form"
