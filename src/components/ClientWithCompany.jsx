...
const ClientWithCompany = () => {
    ...
    const registertypes = ['On Behalf of Company/Business', 'On Behalf of Company/Business', 'On Behalf of Company/Business', 'On Behalf of Company/Business', 'On Behalf of Company/Business'];
    ...
    const companyURLs =['"https://www.linkedin.com/"','https://www.linkedin.com/','https://www.linkedin.com/','https://www.linkedin.com/','https://www.linkedin.com/'];
    const companyemails =['abc@gmail.com','def@gmail.com','ghi@gmail.com','jkl@gmail.com','mno@gmail.com',];
                      ...
                      if (isChecked === true) {
                         ...
                         axios.get(personid+user_data2.email)
                          ...
                          const user_data3 = {
                            ...
                            registrationNumberCIN:data.registrationNumberCIN || randomRegistrationNumberCIN,
                            GSTIN:data.GSTIN || randomGSTINs,
                            companyUrl:data.companyUrl || randomCompanyURL,
                            tagLine:data.tagLine || randomTagline,
                            addressRegisteredOffice:data.addressRegisteredOffice || randomAddress,
  ...
  <form onSubmit={formSubmit}>
    <div className="row jumbotron box8" >
      <div className="col-sm-12 mx-t3 mb-4">
        <h2 className="text-center text-info">Client with Company Register</h2>
      </div>
...
{isChecked && (
      <div className="col-sm-6 form-group label1">
        <label htmlFor="registrationNumberCIN">Registration Number / CIN</label>
        <input
          type="text"
          className="form-control"
          ...
          placeholder=""
          required=""
          value={data.registrationNumberCIN || randomRegistrationNumberCIN} 
          onChange={(event) => {
            inputEvent(event);
